...
class SI_RealEstate extends Pepper
{
	...
	(
		...
		// Common resolutions heights minus realistic worst-case browser chrome (170)
...
<table>
	...
	<tr>
		<td><a href="#default" onclick="document.getElementById('heightGroups').value = '{$defaultGroups['prefs']['heightGroups']}'; return false;" style="float: left; margin: 0 11px 11px 0;"><img src="pepper/shauninman/realestate/images/btn-default-mini-single.png" width="51" height="17" alt="Default" /></a> Common resolution heights minus the realistic worst-case scenario browser chrome height of 56px.</td>
	</tr>
</table>
