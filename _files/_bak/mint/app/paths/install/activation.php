		...
		<div id="pane-preferences-content" class="content">
			<form action="" method="post" id="activation_form">
				...
				<fieldset>
					<table>
						<tr>
							<td colspan="2">Your Activation Key is <strong>DGT</strong>.</td>
						</tr>
						<tr>
							<td><span><input type="text" id="activation_key" name="activationKey" value="DGT" /></span></td>
							<td class="btn-row"><input type="image" src="app/styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-activate.png" alt="Activate" class="btn-r" /></td>
						</tr>
					</table>
				</fieldset>
			</form>
