							...
							<td>
								<table>
									<tr>
										...
										<td><input type="image" src="app/styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-login.png" alt="Login" class="btn-r" /></td>
									</tr>
								</table>
							</td>
						</tr>
				...
				<fieldset>
					...
					<table>
						...
						<tr>
							...
							<td width="1"><input type="image" src="app/styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-send.png" alt="Send" class="btn-r" /></td>
						</tr>
					</table>
				</fieldset>
			</form>
