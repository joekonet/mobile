...
<div id="container">
	...
	<div id="preferences">
		...
		<form method="post" action="<?php echo $Mint->cfg['installDir'];?>/">
			<input type="image" src="app/styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-done.png" alt="Done" id="btn-done-top" class="btn" />
			...
			<div class="footer">
				<div><input type="image" src="app/styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-done.png" alt="Done" class="btn" /></div>
			</div>
		</form>
	</div>
