			...
			<form action="" method="post" onsubmit="return confirmUninstall();">
				<fieldset>
					<table>
						...
						<tr>
							<td><input type="image" src="app/styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-uninstall.png" alt="Uninstall" class="btn" /></td>
							<td><label><input type="checkbox" id="confirm-uninstall" name="confirm" value="true" /> Confirm uninstall</label></td>
							<td class="btn-row"><a href="<?php echo $Mint->cfg['installDir']; ?>/?preferences"><img src="app/styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-cancel.png" width="62" height="22" alt="Cancel" /></a></td>
						</tr>
					</table>
				</fieldset>
			</form>
